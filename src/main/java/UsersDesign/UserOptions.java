...
public class UserOptions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(543, 346));

        jPanel1.setPreferredSize(new java.awt.Dimension(0, 0));

        jButton1.setBackground(new java.awt.Color(151, 52, 221));
        jButton1.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Student scores");
        ...
        jButton2.setBackground(new java.awt.Color(195, 20, 150));
        jButton2.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("Changer career path");
        ...
        jButton3.setBackground(new java.awt.Color(19, 115, 255));
        jButton3.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("Classmates");

        jButton4.setBackground(new java.awt.Color(118, 183, 192));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        StudentScores ScoresWindow=new StudentScores();
        ScoresWindow.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         ChangeCareer CareerWindow=new ChangeCareer();
        CareerWindow.setVisible(true);
        this.dispose();
